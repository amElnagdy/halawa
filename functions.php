...
function halawa_enqueue_assets() {
  
  /* theme's primary style.css file */
  wp_enqueue_style( 'main-css' , get_stylesheet_uri() );
  /* template's primary css file */
  wp_enqueue_style( 'startup-boostrap-css' , get_template_directory_uri() . '/css/blog-home.css' );
...
add_action( 'wp_enqueue_scripts' , 'halawa_enqueue_assets' );
